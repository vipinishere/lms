  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 md:pt-30 pt-20 text-left">
        ...
        {/* right column */}
        <div className="max-w-course-card z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t-sm md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            ...
            {/* rating, duration and total no of lessons */}
