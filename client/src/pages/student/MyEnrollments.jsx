...
const MyEnrollments = () => {
  ...
  const [progressArray, setProgressArray] = useState([
    ...
    { lectureCompleted: 11, totalLectures: 40 },
    { lectureCompleted: 5, totalLectures: 23 },
    { lectureCompleted: 30, totalLectures: 54 },
    { lectureCompleted: 12, totalLectures: 34 },
              ...
              <tr key={index} className="border-b border-gray-500/20">
                ...
                <td className="px-4 py-3 max-sm:text-right">
                  <button
                    ...
                    className="px-3 sm:px-5 py-1.5 sm:py-2 cursor-pointer bg-blue-600 max-sm:text-xs text-white rounded-xl"
                  >
                    {progressArray[index] &&
